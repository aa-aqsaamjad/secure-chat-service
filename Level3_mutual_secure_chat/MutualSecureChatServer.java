...
public class MutualSecureChatServer {

    public static final int PORT = 43221;
    public static ArrayList<MutualSecureChatServerThread> clientThreads = new ArrayList<>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            MutualSecureChatServerThread thread = new MutualSecureChatServerThread(clientSocket);
            thread.start();
    ...
    public static void broadcastMessage(String message, MutualSecureChatServerThread sender) {
        for (MutualSecureChatServerThread clientThread : clientThreads) {
    ...
    public static void removeClient(MutualSecureChatServerThread thread) {
