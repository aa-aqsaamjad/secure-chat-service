...
public class MutualSecureChatServerThread extends Thread {
    ...
    // constructor
    public MutualSecureChatServerThread(SSLSocket socket) {
        this.socket = socket;
    }
    ...
    public void run() {
        ...
        try {
            ...
            MutualSecureChatServer.broadcastMessage("SERVER: " + username + " has joined the chat. Type /quit to exit.", this);
            ...
            while ((line = in.readLine()) != null) {
                ...
                if ("/quit".equalsIgnoreCase(line.trim())) {
                    MutualSecureChatServer.broadcastMessage(username + " has left the chat!", this);
                    MutualSecureChatServer.removeClient(this);
                    break;
                }
                // broadcast message to other clients
                String message = username + ": " + line;
                MutualSecureChatServer.broadcastMessage(message, this);
